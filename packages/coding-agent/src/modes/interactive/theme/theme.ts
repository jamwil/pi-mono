...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@jamwil/pi-tui";
...
const THEME_KEY = Symbol.for("@jamwil/pi:theme");
...
export function getSettingsListTheme(): import("@jamwil/pi-tui").SettingsListTheme {
	return {
