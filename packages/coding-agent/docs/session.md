...
For TypeScript definitions in your project, inspect `node_modules/@jamwil/pi/dist/` and `node_modules/@jamwil/pi-ai/dist/`.
...
### Extended Message Types (from pi / `@jamwil/pi`)
